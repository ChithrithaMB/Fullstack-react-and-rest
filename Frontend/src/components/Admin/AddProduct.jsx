...
const AddProduct = ({ show }) => {
  ...
  const { setProdname, setProdrate, setProdurl, SendtoprodDB, setProdQuantity } = useStates();
  return (
    <>
        ...
        <div className='add-box'>
          ...
          <form onSubmit={SendtoprodDB}>
            ...
            <div className='prodshop-div'>
              <TextField className='prodshop-in' label="Product Instock" variant="standard" required
